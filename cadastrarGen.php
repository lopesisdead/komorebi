<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $teste_gen = $_POST['gen'];
        $sql = "select id_gen from genero where nome_gen = '$teste_gen'";
        $resultado = mysqli_query($conn, $sql);

        if(mysqli_num_rows($resultado) >= 1){
            $erro = "Já existe um gênero com este nome cadastrado!";
            header("location: cadastrarGen.php?mensagem_err={$erro}");
        } else{
            $gen = $_POST['gen'];
            $sql = "insert into genero (nome_gen)
            values('{$gen}')";
            mysqli_query($conn, $sql);
            $mensagem = "Gênero cadastrado com sucesso";
            header("location: cadastrarGen.php?mensagem_suc={$mensagem}");
        }
    }
        ...
        <div class="modal modal-signin position-static d-block" tabindex="-1" role="dialog" id="modalSignin">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                ...
                <div class="modal-header p-5 pb-4 border-bottom-0">
                    <h1 class="fw-bold mb-0 fs-2">Cadastrar gênero</h1>
                </div>
                ...
                <div class="modal-body p-5 pt-0">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        name="gen" id="floatingInput" placeholder="Nome do gênero" required>
