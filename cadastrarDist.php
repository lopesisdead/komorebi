<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $teste_dist = $_POST['dist'];
        $sql = "select id_dist from distribuidora where nome_dist = '$teste_dist'";
        $resultado = mysqli_query($conn, $sql);

        if(mysqli_num_rows($resultado) >= 1){
            $erro = "Já existe uma distribuidora com este nome cadastrada!";
            header("location: cadastrarDist.php?mensagem_err={$erro}");
        } else{
            $dist = $_POST['dist'];
            $sql = "insert into distribuidora (nome_dist)
            values('{$dist}')";
            mysqli_query($conn, $sql);
            $mensagem = "Distribuidora cadastrada com sucesso";
            header("location: cadastrarDist.php?mensagem_suc={$mensagem}");
        }
    }
        ...
        <div class="modal modal-signin position-static d-block" tabindex="-1" role="dialog" id="modalSignin">
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                ...
                <div class="modal-header p-5 pb-4 border-bottom-0">
                    <h1 class="fw-bold mb-0 fs-2">Cadastrar distribuidora</h1>
                </div>
                ...
                <div class="modal-body p-5 pt-0">
                    ...
                    <div class="form-floating mb-3">
                        ...
                        name="dist" id="floatingInput" placeholder="Nome da distribuidora" required>
